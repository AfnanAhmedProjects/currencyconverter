...
class PredictionsPage extends StatelessWidget {
  final Map<String, List<FlSpot>> currencyPredictions = const {
    ...
    'JPY': [FlSpot(0, 110.0), FlSpot(1, 112.0), FlSpot(2, 111.5), FlSpot(3, 110.5)],
    'PKR': [FlSpot(0, 280.0), FlSpot(1, 275.0), FlSpot(2, 278.0), FlSpot(3, 277.0)],
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            ...currencyPredictions.entries.map(
              (entry) => Padding(
                        ...
                        LineChartData(
                          ...
                          lineBarsData: [
                            LineChartBarData(
                              spots: entry.value,
                              isCurved: true,
                              colors: [Colors.teal], // Use List<Color> here
